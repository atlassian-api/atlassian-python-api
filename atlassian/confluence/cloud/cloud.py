...
class ConfluenceCloud(
    ...
    def __getattr__(self, name):
        ...
        if hasattr(self, "_compatibility_method_mapping") and name in self._compatibility_method_mapping:
            ...
            def compatibility_wrapper(*args, **kwargs):
                warnings.warn(
                    f"The method '{name}' is deprecated in ConfluenceCloud. " f"Use '{v2_method_name}' instead.",
                    DeprecationWarning,
                    stacklevel=2,
                )
    ...
    def get_page_by_title(self, space_key: str, title: str, body_format: str = "storage", **kwargs) -> Dict[str, Any]:
        ...
        Returns a dictionary with 'results' key containing matching pages
        to maintain backward compatibility with V1 callers.
        """
        try:
    ...
    def get_page_id(self, space: str, title: str, type: str = "page") -> Optional[str]:
        """
        Get page ID by space key and title using the V2 API.
        Returns the ID from the first result or None if not found.
        """
        res = self.get_page_by_title(space, title)
    ...
    def update_page(
        ...
        data = {
            "id": page_id,
            "version": {"number": version + 1, "message": "Updated via Python API"},  # Increment the version
        }
        ...
        if body:
            data["body"] = {body_format: {"value": body}}
            if representation:
    ...
    def get_trashed_contents_by_space(
        self, space_key: str, cursor: Optional[str] = None, expand: Optional[List[str]] = None, limit: int = 100
    ) -> Dict[str, Any]:
        """
    ...
    def get_page_properties(self, page_id: str, cursor: Optional[str] = None, limit: int = 25) -> List[Dict[str, Any]]:
        """
    ...
    def update_page_property(
        self, page_id: str, property_key: str, property_value: Any, version: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        ...
        data = {
            ...
            "version": {"number": version + 1, "message": "Updated via Python API"},
        }
    ...
    def get_page_labels(
        self, page_id: str, prefix: Optional[str] = None, cursor: Optional[str] = None, limit: int = 25
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_space_labels(
        self, space_id: str, prefix: Optional[str] = None, cursor: Optional[str] = None, limit: int = 25
    ) -> List[Dict[str, Any]]:
        """
    ...
    def create_page_footer_comment(self, page_id: str, body: str, body_format: str = "storage") -> Dict[str, Any]:
        """
        ...
        data = {"pageId": page_id, "body": {body_format: {"representation": body_format, "value": body}}}
    ...
    def create_page_inline_comment(
        self, page_id: str, body: str, inline_comment_properties: Dict[str, Any], body_format: str = "storage"
    ) -> Dict[str, Any]:
        """
        ...
        data = {
            "pageId": page_id,
            "body": {body_format: {"representation": body_format, "value": body}},
    ...
    def create_blogpost_footer_comment(
        self, blogpost_id: str, body: str, body_format: str = "storage"
    ) -> Dict[str, Any]:
        """
        ...
        data = {"blogPostId": blogpost_id, "body": {body_format: {"representation": body_format, "value": body}}}
    ...
    def create_custom_content_comment(
        self, custom_content_id: str, body: str, body_format: str = "storage"
    ) -> Dict[str, Any]:
        """
    ...
    def create_attachment_comment(self, attachment_id: str, body: str, body_format: str = "storage") -> Dict[str, Any]:
        """
        ...
        data = {"attachmentId": attachment_id, "body": {body_format: {"representation": body_format, "value": body}}}
    ...
    def create_comment_reply(self, parent_comment_id: str, body: str, body_format: str = "storage") -> Dict[str, Any]:
        """
    ...
    def create_custom_content(
        ...
        if not any([space_id, page_id, blog_post_id, custom_content_id]):
            raise ValueError(
                "At least one container ID (space_id, page_id, blog_post_id, or custom_content_id) must be provided"
            )
    ...
    def get_custom_content_by_id(self, custom_content_id: str, body_format: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def get_content_by_id(self, content_id: str, **kwargs) -> Dict[str, Any]:
        ...
        warnings.warn("get_content_by_id is deprecated; use get_page_by_id", DeprecationWarning, stacklevel=2)
        return self.get_page_by_id(content_id, **kwargs)

    def get_content(self, **kwargs):
        """Deprecated v1-compatible alias for :meth:`get_pages`."""
    ...
    def delete_content(self, content_id: str):
        ...
        return self.delete_page(content_id)
