...
class Server(ConfluenceServerBase):
    ...
    def get_pages_by_title(self, space, title, start=0, limit=200, expand=None):
        ...
        """
        return self.get_page_by_title(space, title, start=start, limit=limit, expand=expand)
    ...
    def share_with_others(self, page_id, group, message):
        ...
        link: https://jira.atlassian.com/browse/CONFSERVER-96030
        """
    ...
    def reindex(self):
        """
        Trigger reindexing of Confluence content
