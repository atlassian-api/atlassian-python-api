...
class JiraADF:
    ...
    def mention(account_id: str, text: Optional[str] = None) -> Dict[str, Any]:
        ...
        return {
            "type": "paragraph",
            "content": [{"type": "mention", "attrs": {"id": account_id, "text": text or "@user"}}],
        }
    ...
    def inline_mention(account_id: str, text: Optional[str] = None) -> Dict[str, Any]:
        ...
        """
        return {"type": "mention", "attrs": {"id": account_id, "text": text or "@user"}}
    ...
    def table(rows: List[List[str]], headers: bool = False) -> Dict[str, Any]:
        ...
        for i, row in enumerate(rows):
            ...
            row_node = {"type": "tableRow", "content": row_content}
            content.append(row_node)

        return {"type": "table", "attrs": {"isNumberColumnEnabled": False, "layout": "default"}, "content": content}
    ...
    def emoji(shortname: str) -> Dict[str, Any]:
        ...
        """
        return {"type": "emoji", "attrs": {"shortName": shortname}}
