...
class SoftwareJira(CloudJira):
    ...
    def create_board(self, name: str, board_type: str, filter_id: int) -> Dict[str, Any]:
        """
        Create a new board.
        ...
        """
        data = {"name": name, "type": board_type, "filterId": filter_id}
    ...
    def get_board_issues(
        ...
        """
        board_id = self.validate_id_or_key(str(board_id), "board_id")
        params = {"startAt": start_at, "maxResults": max_results, "validateQuery": str(validate_query).lower()}
    ...
    def get_all_sprints(
        self, board_id: int, start_at: int = 0, max_results: int = 50, state: str = None
    ) -> Dict[str, Any]:
        """
    ...
    get_board_sprints = get_all_sprints

    def create_sprint(
        self, name: str, board_id: int, start_date: str = None, end_date: str = None, goal: str = None
    ) -> Dict[str, Any]:
        """
        Create a new sprint.
    ...
    def get_epics(self, board_id: int, start_at: int = 0, max_results: int = 50, done: bool = None) -> Dict[str, Any]:
        """
    ...
    def register_webhook(
        ...
        """
        data = {"url": url, "events": events, "excludeBody": exclude_body}
    ...
    def get_dashboards(self, start_at: int = 0, max_results: int = 50, filter: str = None) -> Dict[str, Any]:
        """
        Get dashboards.
    ...
    def create_filter(self, name: str, jql: str, description: str = None, favorite: bool = False) -> Dict[str, Any]:
        """
        Create a filter.
        ...
        """
        data = {"name": name, "jql": jql, "favourite": favorite}
    ...
    def parse_jql(self, jql: str, validate_query: bool = True) -> Dict[str, Any]:
        ...
        """
        data = {"queries": [{"query": jql, "validation": "strict" if validate_query else "none"}]}
