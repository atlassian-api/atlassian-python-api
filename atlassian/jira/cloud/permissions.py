...
class PermissionsJira(CloudJira):
    ...
    def get_all_permission_schemes(self, expand: str = None) -> Dict[str, Any]:
        """
    ...
    def get_permission_scheme(self, scheme_id: int, expand: str = None) -> Dict[str, Any]:
        """
    ...
    def create_permission_scheme(self, name: str, description: str = None) -> Dict[str, Any]:
        """
    ...
    def get_permission_scheme_grants(self, scheme_id: int, expand: str = None) -> Dict[str, Any]:
        """
    ...
    def create_permission_grant(
        self, scheme_id: int, permission: str, holder_type: str, holder_parameter: str = None
    ) -> Dict[str, Any]:
        """
        ...
        data = {"permission": permission, "holder": {"type": holder_type}}
    ...
    def get_issue_security_scheme(self, scheme_id: int) -> Dict[str, Any]:
        """
    ...
    def get_project_security_levels(self, project_key_or_id: str) -> Dict[str, Any]:
        """
    ...
    def get_my_permissions(
        self, project_key: str = None, issue_key: str = None, permissions: List[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_permitted_projects(self, permission_key: str) -> Dict[str, Any]:
        """
        ...
        """
        data = {"permissions": [permission_key]}
