...
class SoftwareJiraAdapter(SoftwareJira):
    ...
    def boards(
        self, startAt: int = 0, maxResults: int = 50, type: str = None, name: str = None, projectKeyOrId: str = None
    ) -> Dict[str, Any]:
        """
        ...
        """
        warnings.warn(
            "The 'boards' method is deprecated. Use 'get_all_boards' instead.", DeprecationWarning, stacklevel=2
        )
        return self.get_all_boards(
            start_at=startAt, max_results=maxResults, board_type=type, name=name, project_key_or_id=projectKeyOrId
        )
    ...
    def sprints(self, board_id: int, startAt: int = 0, maxResults: int = 50, state: str = None) -> Dict[str, Any]:
        """
        ...
        """
        warnings.warn(
            "The 'sprints' method is deprecated. Use 'get_all_sprints' instead.", DeprecationWarning, stacklevel=2
        )
        return self.get_all_sprints(board_id=board_id, start_at=startAt, max_results=maxResults, state=state)
    ...
    def epics(self, board_id: int, startAt: int = 0, maxResults: int = 50, done: bool = None) -> Dict[str, Any]:
        """
        ...
        """
        warnings.warn("The 'epics' method is deprecated. Use 'get_epics' instead.", DeprecationWarning, stacklevel=2)
        return self.get_epics(board_id=board_id, start_at=startAt, max_results=maxResults, done=done)
    ...
    def rank(self, issues: List[str], rank_before: str = None, rank_after: str = None) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing response information
        """
        warnings.warn("The 'rank' method is deprecated. Use 'rank_issues' instead.", DeprecationWarning, stacklevel=2)
        return self.rank_issues(issue_keys=issues, rank_before=rank_before, rank_after=rank_after)

    # Webhook legacy methods

    def create_webhook(
        self, url: str, events: List[str], jql_filter: str = None, exclude_body: bool = False
    ) -> Dict[str, Any]:
        """
        ...
        return self.register_webhook(url=url, events=events, jql_filter=jql_filter, exclude_body=exclude_body)
    ...
    def webhook(self, webhook_id: int) -> Dict[str, Any]:
        ...
        """
        warnings.warn(
            "The 'webhook' method is deprecated. Use 'get_webhook' instead.", DeprecationWarning, stacklevel=2
        )
    ...
    def webhooks(self) -> List[Dict[str, Any]]:
        ...
        """
        warnings.warn(
            "The 'webhooks' method is deprecated. Use 'get_all_webhooks' instead.", DeprecationWarning, stacklevel=2
        )
        return self.get_all_webhooks()

    # Dashboard and Filter legacy methods

    def dashboards(self, startAt: int = 0, maxResults: int = 50, filter: str = None) -> Dict[str, Any]:
        """
        ...
        """
        warnings.warn(
            "The 'dashboards' method is deprecated. Use 'get_dashboards' instead.", DeprecationWarning, stacklevel=2
        )
        return self.get_dashboards(start_at=startAt, max_results=maxResults, filter=filter)
