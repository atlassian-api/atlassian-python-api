...
class UsersJira(CloudJira):
    ...
    def get_all_users(
        self, start_at: int = 0, max_results: int = 50, include_inactive: bool = False, include_active: bool = True
    ) -> List[Dict[str, Any]]:
        """
        Get all users.
    ...
    def get_user(
        self, account_id: str = None, username: str = None, key: str = None, expand: List[str] = None
    ) -> Dict[str, Any]:
        """
        Get user details.
    ...
    def find_users_for_picker(
        ...
        """
        params = {"query": query, "startAt": start_at, "maxResults": max_results, "showAvatar": show_avatar}
    ...
    def find_users_assignable_to_projects(
        self, query: str, project_keys: List[str], start_at: int = 0, max_results: int = 50
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_user_property(self, account_id: str, property_key: str) -> Dict[str, Any]:
        """
        Get user property.
    ...
    def set_user_property(self, account_id: str, property_key: str, value: Any) -> None:
        """
        Set user property.
        ...
        """
        return self.put(f"rest/api/3/user/properties/{property_key}", params={"accountId": account_id}, data=value)

    def delete_user_property(self, account_id: str, property_key: str) -> None:
        """
    ...
    def get_groups(
        self, query: str = None, exclude: List[str] = None, start_at: int = 0, max_results: int = 50
    ) -> Dict[str, Any]:
        """
        Get groups.
    ...
    def get_group(self, group_name: str, expand: List[str] = None) -> Dict[str, Any]:
        """
        Get group details.
    ...
    def delete_group(self, group_name: str, swap_group: str = None) -> None:
        """
        Delete a group.
    ...
    def add_user_to_group(self, group_name: str, account_id: str) -> Dict[str, Any]:
        ...
        return self.post("rest/api/3/group/user", params={"groupname": group_name}, data=data)
    ...
    def bulk_get_users(self, account_ids: List[str]) -> List[Dict[str, Any]]:
        """
        Bulk get users.
    ...
    def bulk_get_user_properties(
        self, account_ids: List[str], property_keys: List[str] = None
    ...
    def get_user_default_columns(self, account_id: str = None, username: str = None) -> List[Dict[str, Any]]:
        """
    ...
    def set_user_default_columns(self, columns: List[str], account_id: str = None, username: str = None) -> None:
        """
    ...
    def reset_user_default_columns(self, account_id: str = None, username: str = None) -> None:
        """
