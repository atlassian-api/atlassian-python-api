...
class UsersJiraAdapter(UsersJira):
    ...
    def user(
        ...
        """
        warnings.warn(
            "The 'user' method is deprecated. Use 'get_user' instead.", 
            DeprecationWarning, 
            stacklevel=2
        )
    ...
    def search_users(
        ...
        """
        warnings.warn(
            "The 'search_users' method is deprecated. Use 'find_users' instead.", 
            DeprecationWarning, 
            stacklevel=2
        )
    ...
    def group(
        ...
        """
        warnings.warn(
            "The 'group' method is deprecated. Use 'get_group' instead.", 
            DeprecationWarning, 
            stacklevel=2
        )
    ...
    def remove_group(
        ...
        """
        warnings.warn(
            "The 'remove_group' method is deprecated. Use 'delete_group' instead.", 
            DeprecationWarning, 
            stacklevel=2
        )
    ...
    def get_user_columns(
        ...
        return self.get_user_default_columns(
            username=username,
            account_id=account_id
        )
    ...
    def set_user_columns(
        ...
        return self.set_user_default_columns(
            columns=columns,
            username=username,
            account_id=account_id
        )
    ...
    def reset_user_columns(
        ...
        return self.reset_user_default_columns(
            username=username,
            account_id=account_id
        ) 