...
BITBUCKET = Bitbucket(SERVER, username="username", password="password", cloud=True)

try:
    from ..mockup import init_response_mockup

    init_response_mockup(SERVER, os.path.join(os.path.dirname(os.path.abspath(__file__)), "cloud"))
except ImportError:
    pass
