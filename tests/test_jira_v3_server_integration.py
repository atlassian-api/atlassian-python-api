...
class TestJiraV3ServerIntegration(JiraV3ServerIntegrationTestCase):
    ...
    def setUp(self):
        ...
        if self.offline_mode:
            ...
            page1_data = {
                ...
                "total": 10,
                "issues": [
                    {"id": "10001", "key": f"{self.jira_project_key}-1", "fields": {"summary": "Test pagination issue 0"}},
                    {"id": "10002", "key": f"{self.jira_project_key}-2", "fields": {"summary": "Test pagination issue 1"}},
                    {"id": "10003", "key": f"{self.jira_project_key}-3", "fields": {"summary": "Test pagination issue 2"}}
                ]
            }
            ...
            page2_data = {
                ...
                "total": 10,
                "issues": [
                    {"id": "10004", "key": f"{self.jira_project_key}-4", "fields": {"summary": "Test pagination issue 3"}},
                    {"id": "10005", "key": f"{self.jira_project_key}-5", "fields": {"summary": "Test pagination issue 4"}},
                    {"id": "10006", "key": f"{self.jira_project_key}-6", "fields": {"summary": "Test pagination issue 5"}}
                ]
            }
            
            # Setup mock responses
            self.jira.jql_search.side_effect = lambda jql, start_at=0, max_results=50, fields=None, expand=None, validate_query=None: (
            ...
            all_issues = (
                ...
                page2_data["issues"] +
                [
                    {"id": "10007", "key": f"{self.jira_project_key}-7", "fields": {"summary": "Test pagination issue 6"}},
                    {"id": "10008", "key": f"{self.jira_project_key}-8", "fields": {"summary": "Test pagination issue 7"}},
                    {"id": "10009", "key": f"{self.jira_project_key}-9", "fields": {"summary": "Test pagination issue 8"}},
                    {"id": "10010", "key": f"{self.jira_project_key}-10", "fields": {"summary": "Test pagination issue 9"}}
                ]
            )
    ...
    def test_pagination_handling(self):
        ...
        try:
            ...
            all_issues = list(self.jira.get_all_project_issues(self.jira_project_key, fields=["summary"], jql_filter="summary ~ 'Test pagination issue'"))
    ...
    def test_add_and_get_comments(self):
        ...
        try:
            ...
            try:
                ...
                self.assertTrue(comments.get("comments") is not None or comments.get("values") is not None,
...
class TestJiraV3ServerPermissionsIntegration(JiraV3ServerIntegrationTestCase):
    ...
    def setUp(self):
        ...
        if self.offline_mode:
            ...
            permission_error = atlassian.jira.errors.JiraPermissionError(
                "Permission denied",
    ...
    def test_permission_handling(self):
        ...
        try:
            ...
            my_permissions = self.permissions_jira.get_my_permissions(
...
class TestJiraV3ServerSearchIntegration(JiraV3ServerIntegrationTestCase):
    ...
    def test_jql_with_small_page_size(self):
        ...
        while True:
            # Get a page of results
            page = self.search_jira.search_issues(
                jql, 
                max_results=small_page_size,
                start_at=start_at
            )
...
class TestJiraV3ServerVersionCompat(JiraV3ServerIntegrationTestCase):
    ...
    def test_python_version_compatibility(self):
        ...
        print(f"Testing with Python {python_implementation} {python_version.major}.{python_version.minor}.{python_version.micro}")
