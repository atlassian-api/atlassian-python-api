...
def create_page_comment_example(page_id):
    ...
    try:
        ...
        footer_comment = confluence.create_page_footer_comment(
            page_id=page_id, body="This is a test footer comment created via API v2."
        )
        ...
        reply_comment = confluence.create_comment_reply(
            parent_comment_id=footer_comment.get("id"), body="This is a reply to the test footer comment."
        )
