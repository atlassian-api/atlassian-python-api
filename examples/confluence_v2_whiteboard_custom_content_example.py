...
def get_custom_content_example(custom_content_id):
    ...
    try:
        custom_content = confluence.get_custom_content_by_id(custom_content_id=custom_content_id, body_format="storage")
...
def list_custom_content_example(space_id, content_type):
    ...
    try:
        custom_contents = confluence.get_custom_content(
            type=content_type, space_id=space_id, status="current", sort="-created-date", limit=10
        )
...
def custom_content_labels_example(custom_content_id):
    ...
    try:
        ...
        confluence.add_custom_content_label(custom_content_id=custom_content_id, label=label)
        ...
        confluence.delete_custom_content_label(custom_content_id=custom_content_id, label=label)
...
def custom_content_properties_example(custom_content_id):
    ...
    try:
        ...
        property_value = {
            "items": [{"name": "item1", "value": 42}, {"name": "item2", "value": "string value"}],
