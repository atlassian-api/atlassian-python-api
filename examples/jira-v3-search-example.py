...
def main():
    ...
    try:
        ...
        status_suggestions = jira_search.get_field_auto_complete_suggestions(
            field_name="status"
        )
    ...
    try:
        ...
        validation_results = jira_search.validate_jql(
    ...
    try:
        ...
        users = jira_search.search_users(
            query=query,
            max_results=5
        )
    ...
    try:
        ...
        search_results = jira_adapter.jql(
            jql=jql,
